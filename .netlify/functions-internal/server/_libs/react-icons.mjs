...
function SiRazorpay(props) {
	return GenIcon({
		...
		"child": [{
			"tag": "path",
			"attr": { "d": "M22.436 0l-11.91 7.773-1.174 4.276 6.625-4.297L11.65 24h4.391l6.395-24zM14.26 10.098L3.389 17.166 1.564 24h9.008l3.688-13.902Z" },
			"child": []
		}]
	})(props);
}
...
//#endregion
export { SiJavascript as a, SiNodedotjs as c, SiReact as d, SiRedis as f, SiVuedotjs as h, SiGit as i, SiPostgresql as l, SiTypescript as m, SiCloudinary as n, SiMongodb as o, SiTailwindcss as p, SiExpress as r, SiNextdotjs as s, TbApi as t, SiRazorpay as u };
